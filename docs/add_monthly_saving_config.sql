CREATE TABLE IF NOT EXISTS `t_family_monthly_saving_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `account_id` int(11) NOT NULL DEFAULT '0' COMMENT '归属账本',
  `creator_openid` varchar(64) NOT NULL DEFAULT '' COMMENT '创建人',
  `category_name` varchar(32) NOT NULL DEFAULT '' COMMENT '固定储蓄项名称',
  `amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '每月固定金额',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='账本每月固定储蓄配置表';
